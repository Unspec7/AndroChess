...
public class Board {
    ...
    public boolean canCastle(Piece tempKing, Piece tempRook){
        /**@author Jeff
    ...
    public boolean empty(Piece tempKing, Piece tempRook){
        /**@author Jeff
    ...
    public boolean check(int x, int y, char color){
        /**@author Jeff
    ...
    public boolean checkmate(boolean blackTurn) {
        /**@author Jeff
    ...
    public boolean pieceSaveKing(Piece tempKing, boolean blackTurn){
        /**@author Jeff
    ...
    public boolean saveKing(Piece tempKing, Piece tempPiece, boolean blackTurn){
        /**@author Jeff
    ...
    public boolean breakLOS(Piece tempKing, Piece kingSlayer, Piece tempPiece, boolean blackTurn){
        /**@author Jeff
    ...
    public boolean freearoundKing(Piece tempKing, boolean blackTurn){
        /**@author Jeff
    ...
    public boolean stalemate(boolean blackTurn){
        /**@author Jeff
    ...
    public boolean canMove(Piece tempPiece){
        /**@author Jeff
        ...
        for (int x = 0; x < 8; x++){
            for (int y = 0; y < 8; y++){
                if (x != tempPiece.xpos && tempPiece.ypos != y){
                    if (board[x][y] != null){
                        if(board[x][y].color != tempPiece.color ){
                            if ( tempPiece.validMove(tempPiece.xpos, tempPiece.ypos, x, y) ){
    ...
    public boolean check(boolean blackTurn, boolean checkMatechecks, int x, int y) {
        /**@author Jeff
    ...
    public void checkPiece(Piece tempPiece, Piece tempKing){
        /**@author Jeff
    ...
    public boolean checkPath(int oldX, int oldY, int newX, int newY) {
        /**@author Brian
